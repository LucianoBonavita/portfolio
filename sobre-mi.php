...
<body id="sobre-mi">
    ...
    <main>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5 pt-4 pb-5">
                    <h1 class="mt-sm-4 pb-sm-4">Sobre mí</h1>
                    <p class="pb-sm-5">Apasionado por la tecnología y gestión de proyectos. Soy estudiante de cursos de
                        programación Full Stack y de Base de datos.</p>
                    <a href="contacto.php" class="btn btn-rojo">Enviar mensaje</a>

                </div>

                <div class="col-sm-3 col-12 mt-4 oofset-sm-2">
                    <img src="">
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-2 p-5 my-auto d-none d-sm-block">
                            <img src="http://decoyfuego.com.ar/main/img/logoNegro2.jpeg" class="img-fluid baw" title="">
                        </div>
                        <div class="col-12- col-sm-10 p-3">
                            <h4>Ayudante de herrería</h4>
                            <h4>DECO Y FUEGO</h4>
                            <h5>2020 - 2021</h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facere quos aut assumenda explicabo adipisci dolorum inventore cumque, illum distinctio nobis iusto officia. Nostrum ut quidem, eligendi alias error totam cumque!</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="row">
                        <div class="col-2 py-3 my-auto d-none d-sm-block">
                            <img src="http://www.colegioamericano.edu.ar/wp-content/uploads/2015/03/logo-americano-fixed.png" class="img-fluid baw" alt="">
                        </div>

                        <div class="col-12- col-sm-10 p-3">
                            <h3>Egresado en artes visuales</h3>
                            <h4>Colegio Americano Ituzaingo</h4>
                            <h5>2002 – 2020</h5>
                            <p></p>
                        </div>
                    </div>
        ...
        <section id="formacion" class="container mb-5">
            ...
            <div class="row shadow bg-white rounded p-1">
                <div class="col-12 col-sm-6">
                    <div class="row">
                        <div class="col-2 py-3 my-auto d-none d-sm-block">
                            <img src="https://media-exp1.licdn.com/dms/image/C4D0BAQEm82F1ugh0Lw/company-logo_200_200/0/1611935402830?e=2147483647&v=beta&t=vBepQotUcAp7csc7kvF1uo--5W7LosshxoCLD-UkjGc" class="img-fluid baw" title="depcsuite">
                        </div>
                        <div class="col-12- col-sm-10 p-3">
